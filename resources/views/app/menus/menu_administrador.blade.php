<div id="sidebar-menu">
    <ul>
        ...
        <li class="has_sub">
            <a href="javascript:void(0);" class="waves-effect waves-light"><i class="mdi mdi-email"></i><span> Gestión Usuarios </span><span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
